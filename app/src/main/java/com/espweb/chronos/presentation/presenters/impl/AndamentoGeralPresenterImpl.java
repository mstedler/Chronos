...
public class AndamentoGeralPresenterImpl extends AbstractPresenter implements
        AndamentoGeralPresenter, GetAllCronogramasInteractor.Callback {

    private View view;
    private CronogramaRepository cronogramaRepository;

    public AndamentoGeralPresenterImpl(Executor executor, MainThread mainThread, View view, CronogramaRepository cronogramaRepository) {
