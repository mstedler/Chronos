...
public class CronogramaRepositoryImpl implements Repository<Cronograma> {
    ...
    public long insert(Cronograma cronograma) {
        ...
        long id = CronogramaBox.put(sCronograma);
    ...
    public void update(Cronograma cronograma) {
        try {
            com.espweb.chronos.storage.model.Cronograma sCronograma = CronogramaBox.get(cronograma.getId());
    ...
    public Cronograma get(long id) {
        try {
            com.espweb.chronos.storage.model.Cronograma sCronograma = CronogramaBox.get(id);
    ...
    public void delete(Cronograma cronograma) {
        CronogramaBox.remove(cronograma.getId());
        Data idCronograma = new Data.Builder().putString(DeleteCronogramaWorker.KEY_UUID_CRONOGRAMA, cronograma.getUuid()).build();
    ...
    public List<Cronograma> getAll(long userId) {
        ...
        List<com.espweb.chronos.storage.model.Cronograma> sCronogramas = CronogramaBox.getAll(userId);
        try {
            ...
            List<com.espweb.chronos.network.model.Cronograma> nCronogramas = response.body().getCronogramas();
            if (!nCronogramas.isEmpty()) {
                CronogramaBox.deleteCascade(sCronogramas);
                ...
                CronogramaBox.put(sCronogramas);
            }
        } catch (IOException e) {
